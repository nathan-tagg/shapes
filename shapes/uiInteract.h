...
class Interface
{
 public:
  ...
  bool isTab()     const { return isTabPress; };
 ...
 private:
  ...
  static bool isSpacePress;         //    "   space      "
   ...
   static bool isTPress;             //    "   t          "
   static bool isWPress;             //    "   w          "
   static bool isAPress;             //    "   a          "
   static bool isSPress;             //    "   s          "
   static bool isDPress;             //    "   d          "
   static bool isTabPress;           //    "   Tab        "
   static bool isEnterPress;         //    "   Enter      "  
};
